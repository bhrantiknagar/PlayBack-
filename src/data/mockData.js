...
export const mockGenres = [
  { id: 'g-1', name: 'Synthwave', color: 'linear-gradient(135deg, #f43f5e, #ec4899)' },
  { id: 'g-2', name: 'Electronic', color: 'linear-gradient(135deg, #6366f1, #3b82f6)' },
  { id: 'g-3', name: 'Lo-Fi Melodic', color: 'linear-gradient(135deg, #10b981, #06b6d4)' },
  { id: 'g-4', name: 'Ambient Chill', color: 'linear-gradient(135deg, #8b5cf6, #d946ef)' },
  { id: 'g-5', name: 'Cyberpunk', color: 'linear-gradient(135deg, #f59e0b, #ef4444)' },
  { id: 'g-6', name: 'Deep House', color: 'linear-gradient(135deg, #06b6d4, #6366f1)' }
];
